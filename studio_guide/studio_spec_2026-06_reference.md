...
| Small | 1140px | 任意追加 | 約991–1279px |
| Tablet | 840px | ✅ | **691–990px** 🔬 |
...
- 🔬 **実機確認（2026-06-18・azalea セッション）**: タブレットの設定可動域は **「タブレット設定サイズ 691〜990px」** と表示され、**1024px は設定不可**（上限 990）。したがって**原物 `max-width:1024` 帯の構造リフローは Tablet ではなく Small（約991〜1279px）に置く**必要がある。手順書 v02 §0.2/§0.3 はこの方針（Small=1024・Tablet=840 据置）に訂正済み。
